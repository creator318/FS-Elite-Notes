...
Calculate total revenue and total orders for each restaurant. Display restaurant names along with their total revenue and number of orders. Sort by highest revenue first.
